	...
	<view class="onLineRechargePage">
		...
		<view class="rechargeContainer">
			...
			<view class="rechargeContainerType">
				<view
					:class="currentIndex === item.type ?'rechargeContainerTypeItem rechargeContainerTypeItemActive':'rechargeContainerTypeItem' "
			...
			<view class="rechargeContainerList">
				...
				<view class="onlineRechargeButton">
					<button :class="changeRechargeBtnStyle" type="default"
						@click="$u.throttle(withdrawBtnClick, 500)">{{$t('withdraw.button.title.text')}}</button>
				</view>
			</view>
...
<script>
	...
	const TIME_COUNT = 59;
	export default {
		mixins: [myMixin, withdrawMinxi, addSimMinxi, addBankMinxi, addUsdtMinxi, changePhoneMixin],
		data() {
			return {
