...
const store = new Vuex.Store({
	state: {
		...
		inviteState_Bool: false,
		bindPhoneState_Bool: false,
	...
	mutations: {
		...
		save_invite_from(state, content) {
			state.inviteState_Bool = true
			uni.setStorage({
				key: 'queryInviteUrlFrom',
				data: content
			});
		},
		remove_invite_from(state, content) {
			state.inviteState_Bool = false
			uni.removeStorage({
				key: 'queryInviteUrlFrom',
			});
		},
		save_bindphone_from(state, content) {
			state.bindPhoneState_Bool = true
			uni.setStorage({
				key: 'queryBindPhoneUrlFrom',
				data: content
			});
		},
		remove_bindphone_from(state, content) {
			state.bindPhoneState_Bool = false
			uni.removeStorage({
				key: 'queryBindPhoneUrlFrom',
			});
		},
		...
		set_withdraw_model_bool(state, content) {
			state.openWithDrawModelBool = content
		}
	},
	actions: {
