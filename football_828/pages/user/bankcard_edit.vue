			...
			<view class="items">
				...
				<view class="item">
					...
					<u-input type="text" class="uCard"
						...
						:custom-style="customInputStyle" :placeholder-style="placeholderStyle" maxlength="20"
				...
				<view class="item">
					...
					<u-input type="text" class="uCard"
						...
						:custom-style="customInputStyle" :placeholder-style="placeholderStyle" maxlength="16"
						v-model="bankCodeStr" @input="inputBankChange_real" trim />
				</view>
				<view class="item">
		...
		<u-popup v-model="cardsAllPopBool" mode="bottom" width="315px" border-radius="10">
			...
			<view class="cards-pop cards">
				<u-search color="#FFFFFF" shape="square" search-icon-color="#606266"
					:placeholder="$t('user.security.center.bankcard.address.name.text')" bg-color="#171E25"
				...
				<scroll-view scroll-y="true" class="card-list cards-list">
					<view class="card" v-for="(item,index) in defaultTypeList" :key="item.value"
						...
						<u-icon v-if="typeValue === item.value" name="checkmark" color="#ffbc00"></u-icon>
					</view>
				</scroll-view>
			</view>
		</u-popup>
	...
	export default {
		...
		data() {
			return {
				...
				placeholderStyle: "color:#c0c4cc;font-size:13px",
