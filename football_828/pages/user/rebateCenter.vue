				...
				<view class="rebateContainerMain">
					<view class="rebateContainerMainTableBox">
						<view class="rebateContainerMainTableBoxHeader">
							<view class="textCenter_tableBox" style="width: 30%;">
								{{$t('user.rebate.center.list.nav.date.text')}}
							</view>
							<view class="textCenter_tableBox" style="width: 30%;">
								{{$t('user.rebate.center.list.nav.type.text')}}
							</view>
							<view class="textCenter_tableBox" style="width: 40%;">
						...
						<view class="rebateContainerMainTableBoxBody">
							...
							<mescroll-uni ref="mescrollRef" :fixed="false" height="450px" top="0" :topbar="false"
								...
								<view class="rebateContainerMainTableBoxBodyCell" v-for="(item,index) in rebateList"
									:key="item.id">
									<view class="rebateContainerMainTableBoxBodyCell_Date" style="width: 30%;">
										<!-- {{item.createdAt | timeToDate}} -->
										{{item.ymd}}
									</view>
									<view class="rebateContainerMainTableBoxBodyCell_Type" style="width: 30%;">
										<!-- {{$t('user.rebate.center.list.cell.profit.text')}} -->
										{{item.typeName }}
									</view>
									<view class="rebateContainerMainTableBoxBodyCell_Money" style="width: 40%;">
									...
									<!-- <view class="rebateContainerMainTableBoxBodyCell_Operate"
										...
										{{item.status === 1 ? $t('user.rebate.center.list.cell.receive.text') : item.status === 3 ? $t('user.rebate.center.list.cell.wait.person.text') : item.status === 4 ? $t('user.rebate.center.list.cell.wait.person.text') : $t('user.rebate.center.list.cell.already.receive.text')}}
									</view> -->
								</view>
...
<style lang="scss" scoped>
	...
	.head-data {
		...
		width: 100%;
		background: linear-gradient(90deg, #f8c85e, #fa9347);
		border-radius: 5px;
		color: #fff;
