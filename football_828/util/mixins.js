...
export const withdrawMinxi = {
	computed: {
		...mapState(['withdrawState_Bool', 'openWithDrawModelBool']),
	},
	methods: {
		...mapMutations(['save_withdraw_from', 'remove_withdraw_from', 'set_withdraw_model_bool']),
	}
}
...
// invite专用
export const setInviteMixin = {
	computed: {
		...mapState(['inviteState_Bool']),
	},
	methods: {
		...mapMutations(['save_invite_from', 'remove_invite_from']),
	}
}
