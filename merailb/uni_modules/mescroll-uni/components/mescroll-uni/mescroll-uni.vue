<template>
	<view class="mescroll-uni-warp">
		<scroll-view :id="viewId" class="mescroll-uni" :class="{'mescroll-uni-fixed':isFixed}"
			...
			<view class="mescroll-uni-content mescroll-render-touch" @touchstart="wxsBiz.touchstartEvent"
				...
				<view class="mescroll-wxs-content" :style="{'transform': translateY, 'transition': transition}"
					...
					<view v-if="mescroll.optDown.use" class="mescroll-downwarp"
						...
						<view class="downwarp-content">
							<!-- <image class="downwarp-slogan" src="@/static/images/985.gif" mode="aspectFit" v-if="loadgif === 985"/>
							<image class="downwarp-slogan" src="@/static/images/211.gif" mode="aspectFit" v-else="loadgif === 211"/> -->
					...
					<view v-if="mescroll.optUp.use && !isDownLoading && upLoadType!==3" class="mescroll-upwarp"
						...
						<view v-show="upLoadType===1">
							...
							<!-- <image class="downwarp-slogan" src="@/static/images/985.gif" mode="aspectFit"
								v-if="loadgif === 985" />
							<image class="downwarp-slogan" src="@/static/images/211.gif" mode="aspectFit"
								v-else="loadgif === 211" /> -->
						</view>
						<!-- 无数据 -->
...
<script>
	...
	export default {
		...
		mounted() {
			console.log("985", this.isLoadGif);
		},
		computed: {
			// isLoadGif(){
			// 	// let loadImgGifStr = '../../../../static/images/211.gif'
			// 	// if(this.loadgif === 211){
			// 	// 	 : '../../../../static/images/985.gif'
			// 	// }
			// 	console.log("this.loadgif",`../../../../static/images/${this.loadgif}.gif`);
			// 	return `../../../../static/images/${this.loadgif}.gif`
			// 	// ../../../../static/images/211.gif
			// 	// return `../../../../static/images/985.gif`
			// },
