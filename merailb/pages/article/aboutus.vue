	...
	<view class="">
		<view class="articleContainer">
			...
			<view class="detailContent">
				<view class="title_c">
					{{$t('article.no.title.text')}}
				</view>
				<view class="desc_c">
					{{$t('contact.no.time.text')}}
				</view>

				<view class="center_c">
					<h2 style="text-align:center;color:#e67e22">{{$t('about.us.title.text')}}</h2>
					<p>&nbsp;</p>
					<p style="text-align:center;margin-top: 15px;">
						<image src="../../static/images/aboutus.jpg" mode="" style="height:200px; width:327px"></image>
					</p>
					<p style="text-align:center">{{$t('about.us.content.p1.text')}}</p>
					<p style="text-align:center">{{$t('about.us.content.p2.text')}}</p>

					<p style="text-align:center">{{$t('about.us.content.p3.text')}}</p>
					<p style="text-align:center">{{$t('about.us.content.p4.text')}}</p>
					<p></p>
				</view>
			</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				navTitle: this.$t('about.us.title.text'),
			}
		},
		onShow() {
