		...
		<view class="articleContainer">
			...
			<view class="detailContent">
				...
				<view class="center_c">
					...
					<p>{{$t('agent.desc.content.p1.text')}}</p>
					<p>{{$t('agent.desc.content.p2.text')}}</p>
					<p style="text-align:center;margin-top: 15px;">
						<image src="../../static/images/agent.jpg" mode="" style="height:233px; width:350px"></image>
					</p>
...
<script>
	...
	export default {
		...
		data() {
			return {
				navTitle: this.$t('agent.desc.title.text'),
			}
		},
		onShow() {
