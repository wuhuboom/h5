...
export const loginReq = (queryParam) => {
	return ajax(requestCurr + '/client/v1/login', queryParam, 'POST')
}

// 注册的请求接口
export const registerReq = (queryParam) => {
	return ajax(requestCurr + '/client/v1/register', queryParam, 'POST')
}

// 获取个人信息
export const getInformationReq = (token) => {
	return ajax(requestCurr + '/client/v1/getInformation', '', 'POST', token)
}

//获取轮播图
export const getSlideshowReq = (queryParam, token) => {
	return ajax(requestCurr + '/client/v1/getSlideshow', queryParam, 'POST', token)
}

// 获取接单统计
export const getTaskFirstPageReq = (token) => {
	return ajax(requestCurr + '/client/v1/task/getTaskFirstPage', '', 'POST', token)
}

// 获取任务
export const getDoTaskReq = (token) => {
	return ajax(requestCurr + '/client/v1/task/getDoTask', '', 'POST', token)
}


// 提交任务
export const submitDoTaskReq = (queryParam, token) => {
	return ajax(requestCurr + '/client/v1/task/submitTaskOrder', queryParam, 'POST', token)
}

// 获取任务列表
export const getTaskOrderReq = (queryParam, token) => {
	return ajax(requestCurr + '/client/v1/task/getTaskOrder', queryParam, 'POST', token)
}

// 获取金额信息详情
export const getMoneyInformationReq = (token) => {
	return ajax(requestCurr + '/client/v1/getMoneyInformation', '', 'POST', token)
}

// 获取账单
export const getRecordsReq = (queryParam, token) => {
	return ajax(requestCurr + '/client/v1/record/getRecords', queryParam, 'POST', token)
}

// 获取银行列表,获取银行卡信息,修改银行卡信息
export const setBankReq = (queryParam, token, action) => {
	return ajax(requestCurr + '/client/v1/bank/setBank?action=' + action, queryParam, 'POST', token)
}

// 获取充值/支付列表接口
export const rechargeReq = (queryParam, token, action) => {
	return ajax(requestCurr + '/client/v1/record/recharge?action=' + action, queryParam, 'POST', token)
}

// 获取提现/提现手续费接口
export const withdrawReq = (queryParam, token, action) => {
	return ajax(requestCurr + '/client/v1/record/withdraw?action=' + action, queryParam, 'POST', token)
}

// 修改登录密码,提现密码
export const updatePasswordReq = (queryParam, token) => {
	return ajax(requestCurr + '/client/v1/updatePassword', queryParam, 'POST', token)
}


// 获取配置
export const getConfigReq = (queryParam, token) => {
	return ajax(requestCurr + '/client/v1/getConfig', queryParam, 'POST', token)
}
