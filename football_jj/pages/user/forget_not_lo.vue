		...
		<view class="box">
			...
			<view class="item">
				...
				<u-input type="number" class="forgetPassword_item_input phoneView" :clearable="false"
					:placeholder="phonePlace" :custom-style="customInputStyle2" :placeholder-style="placeholderStyle"
			...
			<view class="item">
				...
				<u-input type="text" :clearable="false" class="forgetPassword_item_input" :placeholder="phoneCodePlace"
					:custom-style="customInputStyle2" :placeholder-style="placeholderStyle" maxlength="4"
