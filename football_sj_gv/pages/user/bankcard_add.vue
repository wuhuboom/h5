			...
			<view class="popContent">
				...
				<view class="popContentItem">
					...
					<u-input type="text" class="forgetPassword_item_input"
						...
						:custom-style="customInputStyle" :placeholder-style="placeholderStyle" maxlength="16"
						v-model="bankCodeStr" @input="inputBankChange" />
				</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			commonRuls() {
				// if (this.branchStr && this.accountNameStr && this.cardNumStr && this.cardConfirmNumStr && this.payPwd &&
				// 	this.smsCode && this.bankCodeStr) {
